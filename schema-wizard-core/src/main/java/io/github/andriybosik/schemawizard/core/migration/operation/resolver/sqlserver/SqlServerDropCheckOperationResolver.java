...
public class SqlServerDropCheckOperationResolver implements OperationResolver<DropCheckOperation> {
    private final OperationService operationService;

    public SqlServerDropCheckOperationResolver(OperationService operationService) {
