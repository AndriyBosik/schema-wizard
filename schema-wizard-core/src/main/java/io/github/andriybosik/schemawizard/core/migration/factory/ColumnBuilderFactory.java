...
import io.github.andriybosik.schemawizard.core.migration.builder.column.BoolColumnBuilder;
import io.github.andriybosik.schemawizard.core.migration.builder.column.DateColumnBuilder;
import io.github.andriybosik.schemawizard.core.migration.builder.column.DecimalColumnBuilder;
import io.github.andriybosik.schemawizard.core.migration.builder.column.GenericColumnBuilder;
import io.github.andriybosik.schemawizard.core.migration.builder.column.IntegerColumnBuilder;
import io.github.andriybosik.schemawizard.core.migration.builder.column.TextColumnBuilder;
import io.github.andriybosik.schemawizard.core.migration.builder.column.TimestampColumnBuilder;
