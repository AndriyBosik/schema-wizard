...
public class SqlServerAddUniqueOperationResolver implements OperationResolver<AddUniqueOperation> {
    private final OperationService operationService;

    public SqlServerAddUniqueOperationResolver(OperationService operationService) {
