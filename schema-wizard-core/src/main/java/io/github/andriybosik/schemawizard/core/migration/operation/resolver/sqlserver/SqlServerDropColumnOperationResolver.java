...
public class SqlServerDropColumnOperationResolver implements OperationResolver<DropColumnOperation> {
    private final OperationService operationService;

    public SqlServerDropColumnOperationResolver(OperationService operationService) {
