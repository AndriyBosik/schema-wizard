...
public class MySqlAddForeignKeyOperationResolver implements OperationResolver<AddForeignKeyOperation> {
    private final OperationService operationService;

    public MySqlAddForeignKeyOperationResolver(OperationService operationService) {
