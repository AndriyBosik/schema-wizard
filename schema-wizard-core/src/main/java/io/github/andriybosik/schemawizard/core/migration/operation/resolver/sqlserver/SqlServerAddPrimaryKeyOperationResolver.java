...
public class SqlServerAddPrimaryKeyOperationResolver implements OperationResolver<AddPrimaryKeyOperation> {
    private final OperationService operationService;

    public SqlServerAddPrimaryKeyOperationResolver(OperationService operationService) {
