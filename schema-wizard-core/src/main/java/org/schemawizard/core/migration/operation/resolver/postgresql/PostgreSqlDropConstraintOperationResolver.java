...
public class PostgreSqlDropConstraintOperationResolver implements OperationResolver<DropConstraintOperation> {
    private final OperationService operationService;

    public PostgreSqlDropConstraintOperationResolver(OperationService operationService) {
